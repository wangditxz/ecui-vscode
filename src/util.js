...
const util = {
    ...
    openDefault: () => {
        const browser = util.standardizedBrowserName(util.defaultBrowser());
        util.open("./ecui-doc/controlTree.html", browser);
    },
    standardizedBrowserName: (name = '') => {
    ...
    open: (path1, browser = '') => {
        opn(path.resolve(__dirname, path1), { app: browser }).catch(_ => {
